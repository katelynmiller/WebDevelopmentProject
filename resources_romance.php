...
<body>
  <div class="wrapper">
    ...
    <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="romance.jpg" alt="Card image cap" />
        <li class="list-group-item-primary">Romance Resources</li>
        ...
        >
        <a
          href="https://www.youtube.com/watch?v=L0l5yEY_IlY&list=PL1mtdjDVOoOor6Ihzmr1m6C0SpfMB-0tH&index=15&t=0s"
          class="list-group-item list-group-item-action"
          id="resourceLinks"
          >An Ode to the Romance Novel</a
        >
        <a
